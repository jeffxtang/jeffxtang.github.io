...
**[Update Oct. 7, 2016]** My Android app using the retrained dog model described in step 4 above, followed by running the strip_unused script shown in step 5 (but not the quantize_graph script in step 6), is available for [download at Google Play Store](https://play.google.com/store/apps/details?id=com.ailabby.doggy.
